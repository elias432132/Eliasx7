...
// Configura CORS para aceitar requisições do seu frontend - coloque o domínio real do seu frontend no lugar de '*'
app.use(cors({
  origin: '*', // Para produção, troque '*' pelo domínio do seu frontend, ex: 'https://seu-frontend.github.io'
  methods: ['GET', 'POST'],
  credentials: true
}));
const server = http.createServer(app);
// Configura Socket.io com CORS igual ao express
const io = new Server(server, {
  cors: {
    origin: '*', // igualmente, substitua '*' pelo domínio específico
    methods: ['GET', 'POST']
  }
});
let codigosValidos = {};
...
// Rotas administrativas e de jogo (sem mudanças)
...
app.post('/gerar-pix', async (req, res) => {
  res.json({
    copia_e_cola: "00020126360014br.gov.bcb.pix0114+5511999999999520400005303986540510.005802BR5915Free X7 Teste6009Sao Paulo62070503***63041234"
  });
});
